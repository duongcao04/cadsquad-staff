...
export class JobController {
  ...
  @ApiResponse({ status: 201, description: 'The job has been successfully created.', type: JobResponseDto })
  ...
  @UseGuards(JwtGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get a list of jobs with pagination, filtering, and sorting' })
  @ApiResponse({ status: 200, description: 'Return a list of jobs.', type: [JobResponseDto] })
  ...
  @ApiParam({ name: 'isoDate', type: 'string', description: 'ISO date string' })
  @ApiResponse({ status: 200, description: 'Return a list of jobs.', type: [JobResponseDto] })
  ...
  @ApiResponse({ status: 200, description: 'Return a single job.', type: JobResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Return a list of activity logs.' })
  ...
  @ApiResponse({ status: 200, description: 'The job has been successfully updated.', type: JobResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'The job status has been successfully changed.', type: JobResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'The job has been successfully rescheduled.', type: JobResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'The job has been successfully marked as paid.', type: JobResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'The job statuses have been successfully changed.' })
  ...
  @ApiResponse({ status: 200, description: 'The job members have been successfully updated.', type: JobResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'The member has been successfully removed.', type: JobResponseDto })
