...
const CATEGORIES = [
  { id: "account", label: "Account & Login", icon: User, color: "text-blue-500", bg: "bg-blue-50" },
  { id: "billing", label: "Billing & Invoices", icon: CreditCard, color: "text-emerald-500", bg: "bg-emerald-50" },
  { id: "tech", label: "Technical Support", icon: Zap, color: "text-purple-500", bg: "bg-purple-50" },
  { id: "security", label: "Security & Privacy", icon: Shield, color: "text-rose-500", bg: "bg-rose-50" },
];
    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-12">
      ...
      <div className="bg-slate-900 text-white pt-16 pb-24 px-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-slate-300 text-lg">Search our knowledge base or get in touch with support.</p>
          ...
          <div className="relative">
            <Input
              ...
              classNames={{
                inputWrapper: "bg-white/90 backdrop-blur-md shadow-lg h-14",
              }}
              value={searchQuery}
      ...
      <div className="max-w-[1200px] mx-auto px-8 -mt-12 relative z-20 space-y-12">

        {/* --- QUICK CATEGORIES --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {CATEGORIES.map((cat) => (
            <Card key={cat.id} isPressable className="shadow-lg border border-white hover:-translate-y-1 transition-transform">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <Accordion 
                ...
                className="px-0"
                itemClasses={{
                    base: "group-[.is-splitted]:shadow-sm group-[.is-splitted]:border group-[.is-splitted]:border-slate-200"
                }}
              >
                {FAQS.map((faq) => (
                  <AccordionItem 
                    ...
                    title={<span className="font-semibold text-slate-700">{faq.question}</span>}
                  >
                    <p className="text-slate-500 text-sm pb-2 leading-relaxed">{faq.answer}</p>
                  </AccordionItem>
                ))}
              </Accordion>
            </div>
            ...
            <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 shadow-sm">
                <CardBody className="flex flex-row items-center justify-between p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-slate-800">Developer Documentation</h3>
                            <p className="text-sm text-slate-500">API References, SDKs, and Integration Guides.</p>
                        </div>
                    </div>
                    <Button variant="ghost" color="primary" endContent={<ExternalLink size={16} />}>
                        Visit Docs
                    </Button>
                </CardBody>
            </Card>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="bg-white border border-slate-200 shadow-sm">
                <CardBody className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-bold text-sm text-slate-700">System Operational</p>
                            <p className="text-xs text-slate-400">Last updated: Just now</p>
                        </div>
                    </div>
                    <Button size="sm" variant="light" className="text-xs">View History</Button>
                </CardBody>
            </Card>
            ...
            <Card className="shadow-md border border-slate-200">
                ...
                <CardBody className="p-6 gap-4">
                    ...
                    <Select 
                        ...
                        variant="bordered"
                    >
                        <SelectItem key="bug" startContent={<Zap size={16}/>}>Report a Bug</SelectItem>
                        <SelectItem key="billing" startContent={<CreditCard size={16}/>}>Billing Question</SelectItem>
                        <SelectItem key="account" startContent={<User size={16}/>}>Account Issue</SelectItem>
                        <SelectItem key="other" startContent={<MessageCircle size={16}/>}>Other</SelectItem>
                    </Select>
                    ...
                    <div className="flex items-center gap-2">
                         <Button size="sm" variant="flat" startContent={<Paperclip size={16} />}>
                            Attach Files
                         </Button>
                         <span className="text-xs text-slate-400">Max 5MB (JPG, PNG, PDF)</span>
                    </div>

                    <Button color="primary" className="w-full font-bold mt-2" startContent={<Send size={18} />}>
                        Submit Ticket
                    </Button>
                </CardBody>
            </Card>
            ...
            <div className="text-center space-y-2 pt-4">
                <p className="text-sm text-slate-500">Prefer to email us directly?</p>
                <Link href="mailto:support@hiveq.com" className="font-bold text-primary flex items-center justify-center gap-2">
                    <Mail size={16} /> support@hiveq.com
                </Link>
            </div>
