                            ...
                            {activeTab === 'financials' && (
                                <div className="space-y-6 animate-in fade-in">
                                    ...
                                    <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span
                                                className={`text-sm font-bold ${formData.isPaid ? 'text-emerald-600' : 'text-slate-400'}`}
                                            >
                                                {formData.isPaid
                                                    ? 'PAID'
                                                    : 'UNPAID'}
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {formData.assignees.map((user) => (
                                                <div
                                                    key={user.id}
                                                    className="flex items-center justify-between p-3 border border-slate-200 rounded-xl hover:border-primary transition-colors cursor-pointer group"
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <Avatar
                                                            src={user.avatar}
                                            ...
                                            {formData.files.map((file, idx) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p className="text-sm font-semibold text-slate-700 hover:text-primary hover:underline cursor-pointer">
                                                                {file.name}
                                                            </p>
                                                            <p className="text-xs text-slate-400">
                                                                {file.size} •{' '}
                    ...
                    <Card className="w-full shadow-sm border border-slate-200">
                        ...
                        <CardBody className="p-4 space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-mono font-bold bg-slate-100 px-2 py-0.5 rounded">
                                    {formData.no}
                                </span>
                            </div>
                            <div className="flex justify-between items-center">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <Switch
                                    size="sm"
                                    defaultSelected={formData.isPublished}
                                />
                            </div>
                        </CardBody>
                    </Card>
                    ...
                    <Card className="w-full shadow-sm border border-slate-200 bg-blue-50">
                        <CardBody className="p-4">
                            ...
                            <p className="text-xs text-blue-700 mb-3">
                                Assign more team members to speed up this job.
                            </p>
                            <AvatarGroup
                                isBordered
                                max={4}
