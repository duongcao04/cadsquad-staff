    ...
    <div className="p-8 max-w-[1000px] mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm">Configure global accounting, tax, and notification rules.</p>
        </div>
            ...
            <Card className="shadow-sm border border-slate-200">
              <CardBody className="p-6 gap-6">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Select label="Base Currency" placeholder="Select currency" defaultSelectedKeys={["vnd"]}>
                       <SelectItem key="vnd" value="VND">VND (Vietnam Dong)</SelectItem>
                       <SelectItem key="usd" value="USD">USD (US Dollar)</SelectItem>
                    </Select>
                    <Input label="Currency Symbol" placeholder="e.g. ₫" defaultValue="₫" />
                 </div>
                 <Divider />
                 <div className="flex justify-between items-center">
                    <div>
                        <h4 className="font-bold text-slate-800">Automatic Exchange Rate</h4>
                        <p className="text-xs text-slate-500">Update rates daily via API.</p>
                    </div>
          ...
          >
             <Card className="shadow-sm border border-slate-200">
              <CardBody className="p-6 gap-6">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Input label="Default VAT Rate (%)" type="number" placeholder="8" defaultValue="8" endContent="%" />
                    <Input label="Tax ID (MST)" placeholder="0312345678" />
                    <div className="md:col-span-2">
                        <Input label="Company Name (Invoice Header)" placeholder="YangIs Dev" defaultValue="YangIs Dev" />
                    </div>
                 </div>
              </CardBody>
            </Card>
