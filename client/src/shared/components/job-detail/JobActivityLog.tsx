...
import { TJobActivityLog } from '../../types'
...
export const JobActivityHistory: React.FC<JobActivityHistoryProps> = ({
    ...
    return (
        <ScrollShadow className="h-full w-full pr-4 max-h-[500px]">
...
const ActivityItem = ({ log }: { log: TJobActivityLog }) => {
    ...
    return (
        <div className="relative">
            ...
            <div
                className={`absolute -left-[29px] top-0 flex items-center justify-center w-8 h-8 rounded-full border-2 border-background ${config.bgClass} ${config.textClass}`}
            >
                <Icon size={14} />
            </div>
