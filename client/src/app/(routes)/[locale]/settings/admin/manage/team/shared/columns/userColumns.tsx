...
import UserActiveChip from '@/shared/components/chips/UserActiveChip'
import DepartmentChip from '@/shared/components/chips/DepartmentChip'
...
export function userColumns(
    ...
    const allColumns: TableColumns<UserWithKey> = [
        {
            title: (
                <p className="w-[56px] truncate" title={translations('avatar')}>
                    {translations('avatar')}
                </p>
            ),
            dataIndex: 'avatar',
            ...
            render: (_: unknown, record: UserWithKey) => {
                const src = record.avatar ?? IMAGE_CONSTANTS.loading
                return (
        ...
        {
            title: translations('displayName'),
            ...
            render: (_: unknown, record: UserWithKey) => (
                <div>
                    <p className="line-clamp-1">{record.displayName}</p>
                    <button
                        className="size-full flex items-center justify-start link !text-text2 w-fit"
                        title="Copy username"
                        onClick={() => {
                            {
                                navigator.clipboard
                                    .writeText(record.username)
                                    .then(() => {
                                        addToast({
                                            title: 'Copy username successful',
                                            color: 'success',
                                        })
                                    })
                                    .catch((err) => {
                    ...
                    onClick={() => {
                        {
                            navigator.clipboard
                                ...
                                .then(() => {
                                    addToast({
                                        title: 'Copy contact email successful',
                                        color: 'success',
                                    })
                                })
                                .catch((err) => {
        ...
        {
            title: (
                <p className="truncate" title={translations('phoneNumber')}>
        ...
        {
            title: (
                <p className="truncate" title={translations('department')}>
        ...
        {
            title: (
                <p className="truncate" title={translations('jobTitle')}>
        ...
        {
            title: (
                <p className="truncate" title={translations('isActive')}>
        ...
        {
            title: (
                <p className="truncate" title={translations('lastLoginAt')}>
                    {translations('lastLoginAt')}
                </p>
            ),
        ...
        {
            title: (
                <p className="truncate" title={translations('createdAt')}>
        ...
        {
            title: (
                <p className="truncate" title={translations('updatedAt')}>
        ...
        {
            title: (
                <p className="truncate" title={translations('action')}>
                    {translations('action')}
                </p>
            ),
            key: 'action',
